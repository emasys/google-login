...
Google OAuth2 using the new [**Google Identity Services SDK**](https://developers.google.com/identity/gsi/web) for React forked from [@react-oauth/google](https://www.npmjs.com/package/@react-oauth/google)🚀

## Install

```sh
$ npm install oauth2-google-login@latest

# or

$ yarn add oauth2-google-login@latest
```
